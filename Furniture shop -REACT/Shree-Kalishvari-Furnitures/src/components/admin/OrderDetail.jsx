                                        ...
                                        {order.cartItems.map((item, index) => {
                                            ...
                                            return (
                                                <tr key={index} className="text-black">
                                                    ...
                                                    <td className="h-12 px-6 text-md transition duration-300 border-t border-l text-pink-600  first:border-l-0 border-black stroke-slate-500 text-slate-500 first-letter:uppercase ">
                                                        {order.status}
                                                    </td>
